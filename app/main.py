...
def create_app() -> FastAPI:
    ...
    if not uploads_path.startswith(static_path):
        ...
        logger.error("Upload directory must be outside of static directory for security reasons.")
        raise ValueError("Insecure static file configuration - upload directory is inside static path.")
